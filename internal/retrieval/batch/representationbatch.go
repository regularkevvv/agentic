// Package representationbatch splits an oversized encoding request into
// chunks a provider will accept, and reassembles the chunks into a single
// response that still satisfies the core contract.
//
// It is the multi-output counterpart of internal/embedbatch. The extra work
