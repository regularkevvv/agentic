...
func TestMapEventTable(t *testing.T) {
	...
	cases := []struct {
		...
		{"entry-assistant", sl.Event{Kind: sl.EventEntryCommitted, Position: base, Entry: &sl.Entry{
			Role: sl.RoleAssistant, Origin: sl.OriginAssistant, Blocks: []sl.EntryBlock{
				{Kind: sl.EntryBlockText, Text: "answer"},
				{Kind: sl.EntryBlockToolCall, ToolCall: &sl.EntryToolCall{CallID: "c1", Name: "lookup"}},
			}}},
			func(t *testing.T, mapped []uit.Event) {
		...
		{"entry-tool", sl.Event{Kind: sl.EventEntryCommitted, Entry: &sl.Entry{
			Role: sl.RoleTool, Origin: sl.OriginTool, Blocks: []sl.EntryBlock{
				{Kind: sl.EntryBlockToolResult, Text: "raw", ToolResult: &sl.EntryToolResult{CallID: "c1", Name: "lookup", IsError: true}},
			}}},
			func(t *testing.T, mapped []uit.Event) {
		...
		{"entry-steer", sl.Event{Kind: sl.EventEntryCommitted, Entry: &sl.Entry{
			Role: sl.RoleUser, Origin: sl.OriginSteer, Blocks: []sl.EntryBlock{{Kind: sl.EntryBlockText, Text: "left"}}}},
			func(t *testing.T, mapped []uit.Event) {
		...
		{"entry-follow-up", sl.Event{Kind: sl.EventEntryCommitted, Entry: &sl.Entry{
			Role: sl.RoleUser, Origin: sl.OriginFollowUp, Blocks: []sl.EntryBlock{{Kind: sl.EntryBlockText, Text: "then"}}}},
			func(t *testing.T, mapped []uit.Event) {
		...
		{"entry-start", sl.Event{Kind: sl.EventEntryCommitted, Entry: &sl.Entry{
			Role: sl.RoleUser, Origin: sl.OriginStart, Blocks: []sl.EntryBlock{{Kind: sl.EntryBlockText, Text: "prompt"}}}},
			func(t *testing.T, mapped []uit.Event) {
		...
		{"queue-accepted", sl.Event{Kind: sl.EventQueueAccepted, Position: base, Queue: &sl.QueuedInput{
			ID: "q1", Kind: sl.CommandSteer, Blocks: []sl.InputBlock{{Kind: sl.InputBlockText, Text: "queued"}}}},
			func(t *testing.T, mapped []uit.Event) {
...
func TestFirstInputTextSkipsNonTextBlocks(t *testing.T) {
	t.Parallel()
	if firstInputText([]sl.InputBlock{{Kind: sl.InputBlockData, Data: []byte(`1`)}}) != "" {
		t.Fatal("data block produced text")
	}
	if firstInputText([]sl.InputBlock{{Kind: sl.InputBlockData}, {Kind: sl.InputBlockText, Text: "found"}}) != "found" {
