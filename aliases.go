...
type ModelMetadata = core.ModelMetadata
type ModelMetadataProvider = core.ModelMetadataProvider
...
type PromptCacheRetention = core.PromptCacheRetention
type PromptCacheConfig = core.PromptCacheConfig
...
const (
	...
	PromptCacheNone           = core.PromptCacheNone
	PromptCacheShort          = core.PromptCacheShort
	PromptCacheLong           = core.PromptCacheLong
