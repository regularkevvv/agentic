...
WORKSPACE_PACKAGES := ./... ./harness/... ./harness/codemode/gomonty/... ./harness/sessionloop/... ./harness/store/postgres/... ./tui/... ./e2e/...
...
coverage-all: coverage-check
	...
	$(MAKE) -C harness/store/postgres coverage-check
...
lint:
	...
	cd harness/store/postgres && $(GOLANGCI_LINT) run ./...
